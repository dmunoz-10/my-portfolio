      ...
      <Layout location={this.props.location} title={title}>
        ...
        <div className="flex mb-20 flex-col md:flex-row">
          ...
          <div className="my-auto">
            <h2 className="text-4xl md:text-5xl text-center md:text-left mt-5 md:mt-0">
        ...
        <div>
          ...
          <p className="text-xl">
            ...
            although sometimes I work on some personal frontend projects in
            ...
            <br />
            <br />
            I'm a cinephile, my favorite movie is <strong>Donnie Darko</strong>,
            is an amazing movie, the first time I saw it, it hit right in my
